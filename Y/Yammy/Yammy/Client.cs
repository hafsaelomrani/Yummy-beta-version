    ...
    public partial class Client : Form
    {
        ...
        private void Ajouter_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (nombre() == 0)
                {
                    ...
                    macmd.CommandText = "insert into Client values(@IdC,@nom,@prénom,@tel,@email,@addresse,@Nationalité,@Idr)";
                    ...
                    macmd.Parameters.AddWithValue("@Nationalité", SqlDbType.VarChar).Value = textBoxnat.Text;
                    macmd.Parameters.AddWithValue("@Idr", SqlDbType.VarChar).Value = textBoxidr.Text;
        ...
        private void Modifier_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                macmd.CommandText = "Update Client set Nom=@nom ,Prénom=@prénom,Tel=@tel,Email=@email,Addresse=@addresse,Nationalité=@Nationalité,Idr=@Idr where IdC=@IdC";
                macmd.Parameters.AddWithValue("@IdC", SqlDbType.Int).Value = textBoxN.Text;
                macmd.Parameters.AddWithValue("@nom", SqlDbType.VarChar).Value = textBoxnom.Text;
                macmd.Parameters.AddWithValue("@prénom", SqlDbType.VarChar).Value = textBoxprénom.Text;
                macmd.Parameters.AddWithValue("@tel", SqlDbType.Int).Value = textBoxtel.Text;
        ...
        private void Rechercher_Click(object sender, EventArgs e)
        {
            ...
            if (dr.HasRows == true)
            {
                ...
                textBoxnat.Text = dr[6].ToString();
                textBoxidr.Text = dr[7].ToString();
        ...
        {
            macmd.Connection = macnx;
            macmd.CommandText = "select IdC [Numero],Nom ,Prénom ,Tel ,Email ,Addresse,Nationalité,IdR from Client";
            SqlDataReader DR = macmd.ExecuteReader();
