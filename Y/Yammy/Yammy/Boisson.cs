...
namespace Yammy
{
    public partial class Boisson : Form
    {
        ...
        public int nombre()
        {
            ...
            macmd.CommandText = "select count(IdP) from Boisson where IdP=@IdP";
        ...
        void RempliDGV()
        {
            macmd.Parameters.Clear();
            macmd.Connection = macnx;
            macmd.CommandText = "select IdP [Numero],Nom ,Prix from Boisson";
        ...
        private void Ajouter_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (nombre() == 0)
                {
                    macmd.Parameters.Clear();
                    macmd.Connection = macnx;
                    macmd.CommandText = "insert into Boisson values(@IdP,@nom,@prix)";
                    macmd.Parameters.AddWithValue("@IdP", SqlDbType.Int).Value = textBoxN.Text;
        ...
        private void Supprimer_Click(object sender, EventArgs e)
        {
            if (nombre() != 0)
            {
                macmd.Parameters.Clear();
                macmd.Connection = macnx;
                macmd.CommandText = "Delete from Boisson where IdP=@IdP";
                macmd.Parameters.AddWithValue("@IdP", SqlDbType.Int).Value = textBoxN.Text;
        ...
        private void Modifier_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                macmd.CommandText = "Update Boisson set Nom=@nom ,Prix=@prix  where IdP=@IdP";
                macmd.Parameters.AddWithValue("@IdP", SqlDbType.Int).Value = textBoxN.Text;
                macmd.Parameters.AddWithValue("@nom", SqlDbType.VarChar).Value = textBoxnom.Text;
                macmd.Parameters.AddWithValue("@prix", SqlDbType.VarChar).Value = textBoxprix.Text;
                initialisation(this);
        ...
        private void Rechercher_Click(object sender, EventArgs e)
        {
            macmd.Parameters.Clear();
            macmd.Connection = macnx;
            macmd.CommandText = "select * from Boisson where IdP=@IdP";
            macmd.Parameters.AddWithValue("@IdP", SqlDbType.Int).Value = textBoxN.Text;
            SqlDataReader dr = macmd.ExecuteReader();
            dr.Read();
        ...
        private void Précedent_Click(object sender, EventArgs e)
        {
            ...
            {
                macmd.Connection = macnx;
                macmd = new SqlCommand("select * from Boisson where IdP <" + textBoxN.Text + "order by IdP desc", macnx);
        ...
        private void Suivant_Click(object sender, EventArgs e)
        {
            ...
            {
                macmd.Connection = macnx;
                macmd = new SqlCommand("select * from Boisson where IdP >" + textBoxN.Text + "order by IdP asc", macnx);
